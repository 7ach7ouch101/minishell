...
/*   Updated: 2023/01/10 20:59:49 by mmeziani         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    print_env(t_env *env)
{
    while(env)
    {
        if(!(env->content) && ((ft_strcmp(env->name, "PATH")) 
            || (!ft_strcmp(env->name, "PATH") && ft_strncmp(env->content, "d:", 2))))
            printf("declare -x %s\n", env->name);
        else if (((ft_strcmp(env->name, "PATH")) || (!ft_strcmp(env->name, "PATH") && ft_strncmp(env->content, "d:", 2))))
